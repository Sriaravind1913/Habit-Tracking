...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql' if os.environ.get('POSTGRES_NAME') else 'django.db.backends.sqlite3',
        'NAME': os.environ.get('POSTGRES_NAME') or (BASE_DIR / 'db.sqlite3'),
